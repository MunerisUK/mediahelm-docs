...
📦 **Get the package:** browse published versions on the
**[GitHub Container Registry package page](https://github.com/orgs/MunerisUK/packages/container/package/mediahelm)**.
MediaHelm is a Docker container, so the image reference
`ghcr.io/munerisuk/mediahelm:latest` *is* the install link — Docker pulls it;
there's no browser download. Full walkthrough in the
**[installation guide](https://github.com/MunerisUK/mediahelm-docs)**.
...
| | Link |
|---|---|
| 📦 Container package (browse versions & tags) | <https://github.com/orgs/MunerisUK/packages/container/package/mediahelm> |
| 🏷️ Image reference (the "download" reference) | `ghcr.io/munerisuk/mediahelm:latest` |
| 📖 Installation guide | <https://github.com/MunerisUK/mediahelm-docs> |

Pull it explicitly (optional — `docker run` pulls automatically):
